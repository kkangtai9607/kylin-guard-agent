...
if (__VLS_ctx.result && __VLS_ctx.task) {
    ...
    if (__VLS_ctx.approvals.length) {
        ...
        const { default: __VLS_149 } = __VLS_148.slots;
        {
            ...
            const [scope] = __VLS_getSlotParameters(__VLS_150);
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.result.decision_chain))) {
        // @ts-ignore
        [result,];
        const __VLS_183 = {}.ElTimelineItem;
    ...
    const { default: __VLS_217 } = __VLS_216.slots;
    {
        ...
        const [scope] = __VLS_getSlotParameters(__VLS_218);
    ...
    const { default: __VLS_228 } = __VLS_227.slots;
    {
        ...
        const [scope] = __VLS_getSlotParameters(__VLS_229);
    ...
    const { default: __VLS_247 } = __VLS_246.slots;
    {
        ...
        const [scope] = __VLS_getSlotParameters(__VLS_248);
        (__VLS_ctx.toolTitle(scope.row.tool_name));
        // @ts-ignore
        [toolTitle,];
    }
    ...
    const { default: __VLS_269 } = __VLS_268.slots;
    {
        ...
        const [scope] = __VLS_getSlotParameters(__VLS_270);
